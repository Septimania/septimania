...
$$
{\color{#C40026}\Huge{\textsf{SEPTIMAANIA}}}
$$
...
```mermaid
  graph TD
      ...
      B --> C["<a href="https://languedocnitro.wixsite.com/compagnon">KAASLAS</a>"]
      B --> D["<a href="https://languedocnitro.wixsite.com/rover">ROVER</a>"]
      end
      A --> NITRO
      A --> E["<a href="https://septufmanie.wixsite.com/septufmanie">SEPTUFMAANIA</a>"]
